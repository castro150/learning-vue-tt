...
<div class="form-horizontal">
  ...
  <button class="btn btn-danger" @click="redirectToTimeEntries()">Cancel</button>
  <hr>
</div>
</template>
...
export default {
    ...
    return {
      ...
      timeEntry: {
        user: {
          ...
          image: 'http://1.gravatar.com/avatar/7f4ec37467f2f7db6fffc7b4d2cc8dc2?s=250&d=retro&r=g'
        }
      }
    }
  },
  methods: {
    save() {
      ...
      Event.$emit('time-update', timeEntry)
      this.timeEntry = {}
    },
    redirectToTimeEntries() {
      this.$router.push({
        path: '/time-entries'
      })
    }
